...
export interface AutonomyRunRecord{id:string;startedAt:string;endedAt:string|null;startTick:number;endTick:number|null;startEventId:number;endEventId:number|null;provider:string;initialCompute:number;endingCompute:number|null;computeCeiling:number|null;tickLimit:number|null;executionLimit:number|null;wallClockLimitMs:number|null;terminationReason:string|null;}
